...
class CustomPostTypeController extends BaseController
{
    ...
    public function setSettings() {
        $args = array(
            array(
                'option_group' => 'dillon_plugin_cpt_settings',
                'option_name' => 'dillon_plugin_cpt',
    ...
    public function setFields() {
		$args = array(
			...
			array(
				'id' => 'menu_icon',
				'title' => 'Menu Icon- use Dashicons',
				'callback' => array( $this->cpt_callbacks, 'iconField' ),
				'page' => 'dillon_cpt',
				'section' => 'dillon_cpt_index',
				'args' => array(
					'option_name' => 'dillon_plugin_cpt',
			...
			array(
				'id' => 'menu_position',
				'title' => 'Menu Position',
				'callback' => array( $this->cpt_callbacks, 'numberField' ),
				'page' => 'dillon_cpt',
				'section' => 'dillon_cpt_index',
				'args' => array(
					'option_name' => 'dillon_plugin_cpt',
    ...
    public function storeCustomPostTypes()
	{
		...
		foreach ($options as $option) {
			$this->custom_post_types[] = array(
				...
				'publicly_queryable'    => isset( $option['publicly_queryable'] ) ?: true,
